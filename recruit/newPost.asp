...
<head>
	...
	<meta name="keywords" content="新卒採用の応募を受け付けました,リクルート情報,プログラマ,SE,プログラミング,ソフト開発,ソフトハウス,アイプランニング,能力重視" />
	<meta name="description" content="新卒採用の応募を受け付けました | プログラム開発請負アイプランニング" />
	...
	<title>新卒採用の応募を受け付けました | プログラム開発請負 アイプランニング</title>
...
// ここで情報を送信
	...
	o.Subject = "IPL新卒採用への応募がありました。";
	o.TextBody = "IPLホームページです。お疲れ様です。\n\n"
		 + "先ほど、IPL新卒採用への応募がありました。\n"
		 + "\n"
	...
	o.Subject = param.n +"様　IPL新卒採用応募を受け付けました。";

	var mailbody = "";
	mailbody += "" + param.n + "様\n\n";
	mailbody += "この度は、アイプランニング新卒採用への\n";
	...
	mailbody += "学校名　:" + param.sl + "\n"
	mailbody += "学部　　:" + param.bu + "\n"
	mailbody += "学科　　:" + param.ka + "\n"
	mailbody += "通信欄\n"       + param.c + "\n\n"
